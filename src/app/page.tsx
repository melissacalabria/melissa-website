        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-12 mt-8 md:mt-0">
            ...
            <p className="text-lg mb-4">
              Melissa is a town rich in history and tradition, known for its stunning
              vineyards and exquisite wine production. The name &quot;Melissa&quot;
              derives from the Greek word for &quot;honey,&quot; symbolizing our sweet
              connection to both honey and wine.
            </p>
            <p className="text-lg">
              Join us in exploring the unique blend of ancient traditions and modern
              living that defines Melissa.
            </p>
          </div>
        </div>
      </section>
